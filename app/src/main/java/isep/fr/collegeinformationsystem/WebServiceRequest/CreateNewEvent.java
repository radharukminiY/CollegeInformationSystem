...
public class CreateNewEvent {
    ...
    public CreateNewEvent(Context context, final String eventID, final String eventTitle, final String eventDateTime, final String eventDisrupt, final String eventType, final String eventPlace, final String eventHall, final String eventImg, ServerResponseListener aServerResponseListener) {
    ...
    public void CreateNewEvent() {
        ...
        try {
            ...
            MultipartUtility multipart = new MultipartUtility(Constants.CREATE_NEW_EVENT_URL, charset);
            //add parameters

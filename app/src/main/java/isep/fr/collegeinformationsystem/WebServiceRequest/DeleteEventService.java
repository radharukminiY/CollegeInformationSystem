...
public class DeleteEventService {
    ...
    public DeleteEventService(Context context, final String eventId, ServerResponseListener aServerResponseListener) {
    ...
    public void DeleteEventService() {
        ...
        StringRequest stringRequest = new StringRequest(
                Request.Method.POST,
                Constants.DELETE_EVENT_URL,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        // Do something with response string
                        Log.d(TAG, "delete event String" + String.valueOf(response));
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Constants.EVENT_ID, eventId);

...
import isep.fr.collegeinformationsystem.WebServiceRequest.CreateNewStaff;
...
public class InsertProfessorActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Register New Staff");
        ...
        staffCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (checkInternetConnection()) {
                    ...
                    if (uName != null && !uName.isEmpty() && uMail != null && !uMail.isEmpty() && uMobil != null && !uMobil.isEmpty() &&
                        ...
                        progressDoalog = new ProgressDialog(InsertProfessorActivity.this);
                        progressDoalog.setMessage("Please wait....");
                        progressDoalog.show();

                        CreateNewStaff createNewStaff = new CreateNewStaff(getApplicationContext(), uName, uMail, uQual, subj, uMobil, uGender, uProfilePath, uDept, new createStaffResponse());
    ...
    private void onSelectFromGalleryResult(Intent data) {
        ...
        try {
            ...
            Glide.with(InsertProfessorActivity.this)
    ...
    private class createStaffResponse implements ServerResponseListener {

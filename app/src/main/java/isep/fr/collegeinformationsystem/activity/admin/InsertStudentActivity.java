...
import isep.fr.collegeinformationsystem.WebServiceRequest.CreateNewStudent;
...
public class InsertStudentActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* userGender.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                userSelectGender = adapterView.getItemAtPosition(i).toString();
            ...
            public void onClick(View view) {
                ...
                if (checkInternetConnection()) {
                    ...
                    if (uId != null && !uId.isEmpty() && uName != null && !uName.isEmpty() && uMail != null && !uMail.isEmpty() && uMobil != null && !uMobil.isEmpty() &&
                        ...
                        progressDoalog = new ProgressDialog(InsertStudentActivity.this);
                        progressDoalog.setMessage("Please wait....");
                        progressDoalog.show();

                        CreateNewStudent createNewStudent = new CreateNewStudent(getApplicationContext(), uId, uName, uMail, pass, "student", uMobil, uGender, uProfilePath, uDept, new createStudentResponse());
    ...
    private void onSelectFromGalleryResult(Intent data) {
        ...
        try {
            ...
            Glide.with(InsertStudentActivity.this)
    ...
    private class createStudentResponse implements ServerResponseListener {

...
import isep.fr.collegeinformationsystem.adapter.StudentDepartViewAdapter;
...
public class StudentDepartmentActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, View.OnClickListener {
    private static final String TAG = "StudentDepartment";

    public StudentDepartViewAdapter deptListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.student_depart_recyclerView);
                ...
                if (resultObj != null) {
                    ...
                    if (status.equals("0")) {
                        ...
                        if (jsonArray.length() != 0) {
                            ...
                            deptListAdapter = new StudentDepartViewAdapter(StudentDepartmentActivity.this, courses);
